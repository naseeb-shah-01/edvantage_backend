...
from app.api.v1.endpoints import auth, courses, coursesection, lesson, enrollment,admin, student,users
...
v1_router.include_router(users.app, prefix="/user", tags=["User"])